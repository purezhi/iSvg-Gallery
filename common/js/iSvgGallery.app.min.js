iSvgGallery.app=function(d){var k=d.features,w=d.albums;var G="http://www.w3.org/2000/svg",x="http://www.w3.org/1999/xlink",t="body";galleryElId="canvas";galleryElBgId="background-rect";albumIdPrefix="album",coverIdPrefix="cover",imageIdPrefix="image",listStyleGrid="grid",listStyleFree="free",imageTypeCover="cover",imageTypeImage="image",imageTypeNormal="normal",opacityMaximum=1,opacityMiddle=0.5,opacityMinimum=0,nextAlbumId=0,nextImageId=0,relationAI={},imagesOnGallery=[],topImageOnGallery={},albumsOnGallery=[],topAlbumsOnGallery={},globalArea={},globalArea.noNeedLoad=false,globalArea.tooltip={},globalArea.opacity={},globalArea.debug="",currentTransform=null,galleryMinWidth=1005,galleryMinHeight=618;
...
}ab.preventDefault()},false);window.addEventListener("resize",function(ab){J(document.documentElement.clientWidth,document.documentElement.clientHeight);ab.preventDefault()},false)}function q(af){var ad=Math.floor(galleryViewWidth/albumThumbDiagonal);var ac=Math.floor(galleryViewHeight/albumThumbWidth);
...
}r(ae,af[ae],{translate:ab.translate,position:ab.position})}}}function r(af,ac,ab){if(!ac.id&&ac.id!=0){return}var ae=[];for(var ah=0;ah<ac.images.length;ah++){if(ah>2){break}ae.push(ac.images[ah])}if(ac.cover){ae.push(ac.cover)}var ad=nextAlbumId++;var al=albumIdPrefix+ad;
ab.type=imageTypeCover;ab.album=al;var ak=nextImageId;c(ae,ab);var aj=nextImageId-1;relationAI[al]={};relationAI[al].id=ac.id;relationAI[al].name=ac.name;relationAI[al].cover=ac.cover;relationAI[al].images=[];for(var ag=ak;ag<=aj;ag++){relationAI[al].images.push(coverIdPrefix+ag);
relationAI[coverIdPrefix+ag]={};relationAI[coverIdPrefix+ag].parent=al}var ai=document.createElementNS(G,"g");ai.setAttribute("id",al);ai.vTranslate=[0,0];ai.vScale=1;ai.vRotate=0;ai.addEventListener("mousedown",function(am){K(am,"c","move");am.preventDefault()
},false);document.getElementById(galleryElId).appendChild(ai);albumsOnGallery.push({id:al,position:ab.position})}function c(ab,ad){if(!(ab instanceof Array)){p(ab,ad)}else{for(var ac=0;ac<ab.length;ac++){p(ab[ac],ad)}}}function p(ad,ae){globalArea.noNeedLoad=false;
var ac=new Image();var ab=nextImageId++;ac.onload=function(ag,af){return function(){if(globalArea.noNeedLoad!==false){return}if(topAlbumsOnGallery&&topAlbumsOnGallery.id&&(!ae||ae&&ae.type&&ae.type==imageTypeImage&&ae.album&&topAlbumsOnGallery.id!=ae.album)){return
}if(this.width<imgMinWidth||this.height<imgMinHeight){return}if(ae&&ae.type&&ae.type==imageTypeCover){var ai=U(this,af,ag,opacityMaximum,ae)}else{var ai=o(this,af,ag,opacityMaximum)}if(!ai){return}else{if(topImageOnGallery.id){if(topImageExclusive){C(topImageBgOverlayId)
}C(topImageOnGallery.id)}}if(ae&&ae.type&&ae.type==imageTypeCover){ai.vTranslate=ae.translate;ai.vScale=albumThumbWidth/albumThumbBaseWidth>albumThumbHeight/albumThumbBaseHeight?albumThumbHeight/albumThumbBaseHeight:albumThumbWidth/albumThumbBaseWidth}else{var ah=Z(imageListStyle,4,3,galleryMinWidth/4,galleryMinHeight/3,imagesOnGallery.length,galleryViewWidth,galleryViewHeight);
if(imageListStyle==listStyleGrid&&ah.overflow){n(1,2);ah=Z(imageListStyle,4,3,galleryMinWidth/4,galleryMinHeight/3,imagesOnGallery.length,galleryViewWidth,galleryViewHeight)}ai.vTranslate=ah.translate;var aj=s(this.width,this.height);if(this.height>this.width){ai.vScale=aj.height[0]/this.height+Math.random()*((aj.height[1]-aj.height[0])/this.height)
}else{ai.vScale=aj.width[0]/this.width+Math.random()*((aj.width[1]-aj.width[0])/this.width)}if(ae&&ae.type&&ae.type==imageTypeImage&&ae.album){imagesOnGallery.push({id:(imageIdPrefix+af),uri:this.src,type:imageTypeImage,album:ae.album,position:ah.position})
}else{imagesOnGallery.push({id:(imageIdPrefix+af),uri:this.src,type:imageTypeNormal,position:ah.position})}}ai.style.opacity=opacityMaximum;ai.vRotate=(Math.random()*40)-20;ai.vTranslate[0]=ai.vTranslate[0]>galleryViewWidth?(galleryViewWidth-albumThumbWidth/4):ai.vTranslate[0];
ai.vTranslate[1]=ai.vTranslate[1]>galleryViewHeight?(galleryViewHeight-albumThumbHeight/4):ai.vTranslate[1];z(ai.id);X(ai,imageDefaultOpacity)}}(ad,ab);ac.src=ad}function o(ab,ad,ac,ai){var am=imageIdPrefix+ad;var ah=document.createElementNS(G,"g");ah.setAttribute("id",am);
ah.addEventListener("mouseover",e,false);ah.addEventListener("mouseout",g,false);ah.addEventListener("mousedown",function(an){if(!f("webkit")){C(am)}m(an,"c","move");an.preventDefault()},false);ah.addEventListener("dblclick",function(an){l(am);an.preventDefault()
},false);if(ai!=null){ah.style.opacity=ai}var ae=document.createElementNS(G,"image");ae.setAttribute("id",am+"-img");A(ae,-ab.width/2,-ab.height/2,ab.width,ab.height);ae.setAttribute("preserveAspectRatio","xMinYMin slice");ae.setAttributeNS(x,"href",ac);ah.appendChild(ae);
var ak=document.createElementNS(G,"rect");ak.setAttribute("id",am+"-border");ak.setAttribute("class",imageBorderClass);A(ak,-ab.width/2,-ab.height/2,ab.width,ab.height);ak.setAttribute("rx",imageBorderRadius);ak.setAttribute("ry",imageBorderRadius);var af=imageBorderStrokeWidth*ab.width/galleryMinWidth;
af=af<imageBorderStrokeWidthMin?imageBorderStrokeWidthMin:af;ak.setAttribute("stroke-width",af);ah.appendChild(ak);var al=document.createElementNS(G,"g");al.setAttribute("id",am+"-overlay");al.setAttribute("class",imageOverlayClass);al.setAttribute("style","visibility: hidden");
var aj=ab.width>ab.height?ab.height:ab.width;var ag=aj/5>hotSpotSide?hotSpotSide:aj/5;ag=ag<hotSpotSideMinimum?hotSpotSideMinimum:ag;al.appendChild(Q(am+"-tl",-ab.width/2,-ab.height/2,ag,ag,hotSpotFillColor,hotSpotStrokeColor,function(an){return m(an,"tl","rotate")
},hotSpotClass));al.appendChild(Q(am+"-tr",ab.width/2-ag,-ab.height/2,ag,ag,hotSpotFillColor,hotSpotStrokeColor,function(an){return m(an,"tr","rotate")},hotSpotClass));al.appendChild(Q(am+"-br",ab.width/2-ag,ab.height/2-ag,ag,ag,hotSpotFillColor,hotSpotStrokeColor,function(an){return m(an,"br","rotate")
},hotSpotClass));al.appendChild(Q(am+"-bl",-ab.width/2,ab.height/2-ag,ag,ag,hotSpotFillColor,hotSpotStrokeColor,function(an){return m(an,"bl","rotate")},hotSpotClass));ah.appendChild(al);document.getElementById(galleryElId).appendChild(ah);return ah}function U(ab,ad,ac,ai,ae){var ag=albumThumbBaseWidth;
var ak=albumThumbBaseHeight;var al=coverIdPrefix+ad;var ah=document.createElementNS(G,"g");ah.setAttribute("id",al);ah.addEventListener("mousedown",function(am){K(am,"c","move");am.preventDefault()},false);ah.addEventListener("mouseover",function(am){H(am);
am.preventDefault()},false);ah.addEventListener("dblclick",function(am){F();T(al);am.preventDefault()},false);if(ai!=null){ah.style.opacity=ai}var af=document.createElementNS(G,"image");af.setAttribute("id",al+"-img");A(af,-ag/2,-ak/2,ag,ak);if(f("webkit")){af.setAttribute("preserveAspectRatio","xMinYMin slice")
}else{af.setAttribute("preserveAspectRatio","xMidYMid slice")}af.setAttributeNS(x,"href",ac);ah.appendChild(af);var aj=document.createElementNS(G,"rect");aj.setAttribute("id",al+"-border");aj.setAttribute("class",coverBorderClass);A(aj,-ag/2,-ak/2,ag,ak);aj.setAttribute("rx",coverBorderRadius);
aj.setAttribute("ry",coverBorderRadius);ah.appendChild(aj);if(document.getElementById(R(al))){document.getElementById(R(al)).appendChild(ah)}return ah}function m(ae,ad,ag){if(currentTransform!=null){return}var af=P(ae);if(!af){return}var ac=document.getElementById(af);
if(!ac){return}var ab=document.getElementById(af+"-img");var ah=ab.width.baseVal.value>ab.height.baseVal.value?imgZoomMinWidth/ab.width.baseVal.value:imgZoomMinHeight/ab.height.baseVal.value;currentTransform={what:ag,el:af,corner:ad,g:ac,s:ac.vScale,sx:ah,r:ac.vRotate,t:ac.vTranslate,x:ae.clientX,y:ae.clientY};
X(currentTransform.g,imageHoverOpacity)}function K(ad,ac,af){if(currentTransform!=null){return}var ae=P(ad);if(!ae){return}if(ae.indexOf(albumIdPrefix)<0){ae=R(ae)}var ab=document.getElementById(ae);if(!ab){return}currentTransform={what:af,el:ae,corner:ac,g:ab,s:ab.vScale,sx:0,r:ab.vRotate,t:ab.vTranslate,x:ad.clientX,y:ad.clientY};
X(currentTransform.g,imageHoverOpacity)}function F(ac){globalArea.noNeedLoad=true;if(topImageOnGallery.id){l(topImageOnGallery.id);topImageOnGallery={}}if(imagesOnGallery instanceof Array){while(imagesOnGallery.length>0){var ab=document.getElementById(imagesOnGallery.shift().id);
if(ab){document.getElementById(galleryElId).removeChild(ab)}}}if(topAlbumsOnGallery.id){y(topAlbumsOnGallery.id,false)}topAlbumsOnGallery={};j(false,ac)}function i(ab){if(imagesOnGallery instanceof Array){for(var ac=0;ac<imagesOnGallery.length;ac++){if(imagesOnGallery[ac].id==ab){return imagesOnGallery[ac]
}}}}function e(ab){var ac=P(ab);if(!ac){return}if(topImageOnGallery.id!=ac||(topImageResizable&&topImageOnGallery.id==ac)){document.getElementById(ac+"-overlay").style.visibility="visible"}ab.preventDefault()}function H(ac){var ad=P(ac);if(!ad){return}var ab=E(ad);
if(ab&&ab.name){I(ac,ab.name,false,300000)}ac.preventDefault()}function g(ab){var ac=P(ab);if(!ac){return}document.getElementById(ac+"-overlay").style.visibility="hidden";ab.preventDefault()}function Y(ad){var ab=P(ad);var ae;if(ab.indexOf(albumIdPrefix)==0){var ac=ab;
var ae=document.getElementById(ab)}else{if(ab.indexOf(coverIdPrefix)==0){var ac=R(ab);var ae=document.getElementById(ac)}}if(ae&&topAlbumsOnGallery.id&&topAlbumsOnGallery.id!=ac){X(ae,albumClosedOpacity,imageHoverOpacity);currentTransform=null;ad.preventDefault();
return true}else{if(ae&&topAlbumsOnGallery.id&&topAlbumsOnGallery.id==ac){X(ae,albumOpenedOpacity,imageHoverOpacity);currentTransform=null;ad.preventDefault();return true}}if(currentTransform){X(currentTransform.g,imageDefaultOpacity,imageHoverOpacity)}currentTransform=null;
ad.preventDefault();return true}function b(am){if(globalArea&&globalArea.tooltip){for(var ah in globalArea.tooltip){if(P(am).indexOf(coverIdPrefix)==-1){clearTimeout(globalArea.tooltip[ah].func);var ai=document.getElementById(globalArea.tooltip[ah].id);if(ai){ai.parentNode.removeChild(ai)
}delete globalArea.tooltip[ah]}else{if(currentTransform){var ai=document.getElementById(globalArea.tooltip[ah].id);if(ai){ai.parentNode.removeChild(ai)}}}}}if(currentTransform==null){return}var ak=am.clientX;var aj=am.clientY;var al=currentTransform.g.vTranslate;
if(currentTransform.what=="rotate"){var ab=360/(2*Math.PI);var ad=Math.atan2(currentTransform.y-al[1],currentTransform.x-al[0])*ab;var an=Math.atan2(aj-al[1],ak-al[0])*ab;currentTransform.g.vRotate+=(an-ad);var ag=Math.sqrt(Math.pow(currentTransform.y-al[1],2)+Math.pow(currentTransform.x-al[0],2));
var ac=Math.sqrt(Math.pow(aj-al[1],2)+Math.pow(ak-al[0],2));var ae=currentTransform.g.vScale*(ac/ag);currentTransform.g.vScale=ae>currentTransform.sx?(ae>1?1:ae):currentTransform.sx}else{if(currentTransform.what=="move"){var ao=am.clientX-currentTransform.x;
var af=am.clientY-currentTransform.y;currentTransform.g.vTranslate=[al[0]+ao,al[1]+af]}}currentTransform.x=ak;currentTransform.y=aj;z(currentTransform.el);am.preventDefault()}function T(ad){if(ad.toString().indexOf(albumIdPrefix)==0){var ac=ad}else{if(ad.toString().indexOf(coverIdPrefix)==0){var ac=R(ad)
}else{var ac=albumIdPrefix+ad}}var ab=E(ac);c(ab.images,{type:imageTypeImage,album:ac});topAlbumsOnGallery.id=ac;y(ac,true);j(true,true,ac)}function v(ac,ad,ab,ae){topImageOnGallery.id=ac;topImageOnGallery.transform={};topImageOnGallery.transform.vTranslate=ad.vTranslate;
...
var ag=R(ai);var au=ag+"-tooltip";var aB=ag+"-tooltip-function";if(document.getElementById(au)||(!ap&&globalArea.tooltip[aB])){return}if(!ap){globalArea.tooltip[aB]={};globalArea.tooltip[aB].src=ag;globalArea.tooltip[aB].id=au;globalArea.tooltip[aB].func=setTimeout(function(){return function(){I(an,ax,true,af)
...
setTimeout(function(){document.getElementById(galleryElId).removeChild(ac);delete globalArea.tooltip[aB]},(af?af:3000));C(au)}function A(ae,ab,af,ac,ad){ae.setAttribute("x",ab);ae.setAttribute("y",af);ae.setAttribute("width",ac);ae.setAttribute("height",ad)
}function C(ac){var ab=document.getElementById(ac);ab.parentNode.removeChild(ab);document.getElementById(galleryElId).appendChild(ab)}function X(ad,af,ac){if(!ad){return}var ab=ad.id+"-function";if(globalArea.opacity[ab]){clearTimeout(globalArea.opacity[ab].func)
}else{globalArea.opacity[ab]={};globalArea.opacity[ab].id=ad.id}ad.style.opacity=(ac||ac==0)?parseFloat(ac):((ad.style.opacity||ad.style.opacity==0)?parseFloat(ad.style.opacity):1);var ae=parseFloat(ad.style.opacity);fd=parseFloat(af);if(ae<fd){M(ad,fd)}else{if(ae>fd){h(ad,fd)
}}}function h(ad,ac){if(!ad){return}if(parseFloat(ad.style.opacity)<=parseFloat(ac)){return}ad.removeAttribute("opacity");var ab=ad.id+"-function";var ae=function(){var af=parseFloat(ad.style.opacity)-0.05;ad.style.opacity=af;if(af>parseFloat(ac)){globalArea.opacity[ab].func=setTimeout(ae,10)
}else{delete globalArea.opacity[ab]}};ae()}function M(ad,ac){if(!ad){return}if(parseFloat(ad.style.opacity)>=parseFloat(ac)){return}ad.removeAttribute("opacity");var ab=ad.id+"-function";var ae=function(){var af=parseFloat(ad.style.opacity)+0.05;ad.style.opacity=af;
if(af<parseFloat(ac)){globalArea.opacity[ab].func=setTimeout(ae,10)}else{delete globalArea.opacity[ab]}};ae()}function L(){var ab=document.createElementNS(G,"defs");var ac=document.createElementNS(G,"filter");ac.setAttribute("id","gaussianBlur");var ad=document.createElementNS(G,"feGaussianBlur");
